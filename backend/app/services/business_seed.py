...
DEFAULT_BUSINESS_CAPABILITY_SEEDS: list[BusinessCapabilitySeed] = [
    ...
    BusinessCapabilitySeed(
        ...
        display_name="图裂变 · GPT Image 2 + VL 新版",
        description="AI 团队 2026-05-12 交付的新商业模型裂变方案：先用 VL 生成图案结构卡，再编译提示词并调用 GPT Image 2 图片编辑能力。",
        status="active",
        is_default=False,
