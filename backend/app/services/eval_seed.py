    ...
    # 图编辑 / 中台原生业务接口：GPT Image 2 组件工作台
    {
        ...
        "parameters_schema": {
            "fields": [
                ...
                {"name": "instruction", "label": "编辑指令", "type": "textarea", "required": False, "defaultValue": "", "description": "用自然语言描述要改哪里、改成什么；扩展画布可不填，默认自然补全外扩区域。"},
                ...
                {"name": "targetWidth", "label": "扩展画布目标宽度", "type": "number", "required": False, "defaultValue": "", "description": "扩展画布模式使用；中台会向上取整到 16 的倍数。"},
                {"name": "targetHeight", "label": "扩展画布目标高度", "type": "number", "required": False, "defaultValue": "", "description": "扩展画布模式使用；中台会向上取整到 16 的倍数。"},
                {"name": "anchor", "label": "扩展锚点", "type": "select", "required": False, "defaultValue": "center", "description": "扩展画布模式使用；默认居中。", "options": [
