...
from .vidu import ViduVideoExecutorAdapter
...
registry.register("vidu", ViduVideoExecutorAdapter())
registry.register("vidu-video", ViduVideoExecutorAdapter())
registry.register("vidu_video", ViduVideoExecutorAdapter())
