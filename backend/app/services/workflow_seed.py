    ...
    return [
        WorkflowSeed(
            ...
            metadata={
                ...
                "routing_note": "2026-05-15: 233 lacks String; keep on 5090 until node parity is restored.",
            },
        ),
        WorkflowSeed(
...
def _build_binding_seeds() -> list[WorkflowBindingSeed]:
    return [
        WorkflowBindingSeed(
            ...
            priority=100,
            enabled=False,
            metadata={"notes": "Disabled 2026-05-15: 233 lacks custom String node required by this workflow"},
        ),
        WorkflowBindingSeed(
