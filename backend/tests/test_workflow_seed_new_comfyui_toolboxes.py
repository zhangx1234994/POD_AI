...
LEGACY_SEAMLESS_WORKFLOW = "workflow_comfyui_sifang_lianxu_v1"
...
def test_new_comfyui_bindings_cover_two_executors():
    ...
    assert bindings_by_pair[(LEGACY_SEAMLESS_WORKFLOW, "executor_comfyui_seamless_117")].enabled is False
    assert bindings_by_pair[(LEGACY_SEAMLESS_WORKFLOW, "executor_comfyui_pattern_extract_158")].enabled is True
...
def test_core_comfyui_workflows_have_dual_executor_bindings():
    ...
    assert executors_by_workflow[LEGACY_SEAMLESS_WORKFLOW] == {"executor_comfyui_pattern_extract_158"}
