...
2. `docs/strategy/v0.6-closure-standardization-plan.md`
3. `docs/strategy/v0.6-closure-inventory-2026-06-07.md`
4. `docs/strategy/v0.6.3-control-plane-hardening-plan.md`
5. `docs/strategy/mid-platform-completeness-v0.6-plan.md`
6. `docs/strategy/ability-governance-operating-model-v0.6.md`
7. `docs/strategy/ability-definition-v0.6.md`
8. `docs/strategy/ability-api-gap-v0.6.md`
9. `docs/strategy/business-agent-runtime-v0.6.md`
10. `docs/strategy/client-parallel-preview-v0.6-handoff.md`
11. `docs/standards/release-sop.md`
12. `docs/standards/version-acceptance-template.md`
13. `docs/standards/agent-runtime-regression-matrix.md`
14. `docs/standards/eval-ability-interaction-state-model.md`
15. `docs/api/INDEX.md`
...
| 当前方案 | `docs/strategy/v0.6-closure-standardization-plan.md` | v0.6 收口、缺失补齐、交互纠偏、接口文档和机制标准化 |
| 当前盘点 | `docs/strategy/v0.6-closure-inventory-2026-06-07.md` | v0.6 收口 P0/P1/P2 缺口、证据和整改批次 |
| 上阶段封版方案 | `docs/strategy/v0.6.3-control-plane-hardening-plan.md` | v0.6.3 控制面承压、Agent 样板整改、能力治理降噪和封版门禁 |
| 阶段基准 | `docs/strategy/mid-platform-completeness-v0.6-plan.md` | v0.6 中台能力治理、客户端支撑底座和各端边界 |
...
| 后续路线储备 | `docs/strategy/v0.7-ability-productization-agent-orchestration-plan.md` | v0.7 能力产品化、Agent 编排和质量迭代方向；当前不执行 |
...
- 当前不进入 v0.7；`88d48dce` 完成 Agent 与控制面补充验收，`6ba720e3` 完成测评端能力首页收口并已上线，这些作为 v0.6 收口基础。
- 下一阶段优先做全量缺失盘点、业务处理机制标准化、交互治理、接口文档与错误契约补齐、能力缺口和样例质量补齐、全链路回归和收口复盘。业务流程由客户端组装，中台负责能力治理和证据沉淀。项目/工作单不是中台主视角，现有 `projectId` 只作为兼容上下文字段。
