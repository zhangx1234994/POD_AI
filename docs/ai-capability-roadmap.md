...
0. ✅（2026-06-09）KIE 视频能力先接入 `veo3_fast`，后端强制模型锁定并关闭默认 fallback；视频结果归入 `videos/videoUrls`，远端 URL 继续沉淀到自有 OSS。
...
> 后续迭代请以 `docs/strategy/todo-master-2026q2.md` 作为唯一待办入口；本文只保留路线图背景，避免旧 backlog 和当前任务池并存。
