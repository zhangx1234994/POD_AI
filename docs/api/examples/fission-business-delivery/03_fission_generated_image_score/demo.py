#!/usr/bin/env python3
"""Run generated-image fission score through PODI business API."""
...
def main() -> None:
    submit_payload = {
        ...
        "source": "partner-api",
        "channel": "open-api",
        "requestId": f"biz-fission-score-{int(time.time())}",
        "traceId": f"trace-fission-score-{int(time.time())}",
    }
    created = post_json("/api/business/fission-evaluate/runs", submit_payload)
