...
| FLUX2 裂变 + 四方 | `flux2_9b_liebian_sifang` | `comfyui.flux2_9b_liebian_sifang` | `7629026792103215104` · `Liebian_comfyui_wenzi_1` | `/api/coze/podi/comfyui/execute/flux2-9b-liebian-sifang/openapi.json` | `url / prompt` | 同时出现在 `图裂变` 和 `四方/两方连续图类`。 |
