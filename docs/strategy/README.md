...
4. `../standards/version-acceptance-template.md`
5. `../standards/agent-runtime-regression-matrix.md`
6. `../standards/eval-ability-interaction-state-model.md`
7. `ability-definition-v0.6.md`
8. `business-agent-runtime-v0.6.md`
9. `ability-governance-operating-model-v0.6.md`
10. `ability-api-gap-v0.6.md`
11. `client-parallel-preview-v0.6-handoff.md`
12. `v0.6-closure-inventory-2026-06-07.md`
13. `v0.6-closure-standardization-plan.md`
14. `v0.6.3-control-plane-hardening-plan.md`
15. `project-half-year-review-2026-05-26.md`
16. `platform-polish-v0.5-decision-plan.md`
17. `output-quality-review-v0.5.md`
...
- 当前重点：v0.7 子版本拆分、全局交互治理、Agent Runtime v2、首批能力产品化、质量迭代、控制面预聚合和文档入口切换。
