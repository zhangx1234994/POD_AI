...
| v0.4 方案 | `docs/strategy/business-orchestration-workbench-v0.4-plan.md` | 当前版本执行方案 |
| v0.3 阶段方案 | `docs/strategy/business-orchestration-workbench-v0.3-plan.md` | 已完成阶段记录，保留为 v0.4 背景 |
| 控制点矩阵 | `docs/strategy/business-control-point-matrix-2026-05-19.md` | 当前四个核心业务的控制点去重依据 |
| v0.2 阶段方案 | `docs/strategy/business-control-plane-v0.2-plan.md` | 已完成阶段记录，保留为 v0.4 背景 |
...
| 文档 | 当前处理 |
| --- | --- |
| `docs/strategy/business-orchestration-control-plane-v1.md` | 作为 v0.4 的上层背景，不再直接当执行清单 |
| `docs/strategy/business-orchestration-workbench-v0.3-plan.md` | v0.3 已完成，作为 v0.4 背景和阶段记录 |
| `docs/strategy/business-control-plane-v0.2-plan.md` | v0.2 已完成，作为 v0.4 背景和阶段记录 |
...
| 新增 v0.3 方案入口 | `business-orchestration-workbench-v0.3-plan.md` 当时成为执行方案，现已降级为阶段记录 |
| 新增控制点盘点矩阵 | `business-control-point-matrix-2026-05-19.md` 成为 v0.3 去重依据 |
| 更新战略索引 | v0.3 方案置于战略文档清单前列，v0.2 降级为阶段记录 |
| 更新唯一 TODO 当前焦点 | 当时切换到 v0.3 业务编排工作台与控制点去重版，现已完成 |
