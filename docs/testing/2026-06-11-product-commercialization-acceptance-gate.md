...
- 2026-06-13：线上 114 复测发现 SVG 贴图会导致服务端轻量渲染 `PRODUCT_3D_RENDER_VIDEO_TEXTURE_LOAD_FAILED`，原因是浏览器 Three.js 可加载 SVG，而后端 Pillow 读取器不稳定支持 SVG。已将 3D 服务端样例和测试切到 PNG，并在测评端提交服务端 MP4/OSS 前提示 SVG 需要先转为 PNG/JPG/WebP。
