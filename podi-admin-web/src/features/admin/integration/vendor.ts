...
const vendorIssueLabels: Record<string, string> = {
  ...
  VENDOR_API_KEY_RECENT_ERROR: '密钥最近报错',
  ...
  VENDOR_MODEL_INACTIVE: '模型未启用',
  VENDOR_MODEL_ACCEPTANCE_REQUIRED: '缺少模型验收',
  VENDOR_MODEL_RUNTIME_KEY_MISSING: '模型缺少可用密钥',
  VENDOR_MODEL_KEY_CHECK_FAILED: '密钥验证失败',
  VENDOR_MODEL_KEY_CHECK_PARTIAL_FAILED: '部分密钥验证失败',
  VENDOR_MODEL_KEY_NEVER_CHECKED: '密钥未验证',
  VENDOR_MODEL_KEY_CHECK_STALE: '密钥验证过期',
  VENDOR_MODEL_API_TYPES_MISSING: '能力类型未填写',
  VENDOR_MODEL_EXECUTION_MODE_MISSING: '返回方式未填写',
  VENDOR_MODEL_GLOBAL_EGRESS_REQUIRED: '需要出网节点',
