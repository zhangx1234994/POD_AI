...
MAX_UNRESOLVED_BUSINESS_ISSUES="${MAX_UNRESOLVED_BUSINESS_ISSUES:-5}"
MAX_BUSINESS_GOVERNANCE_WARNINGS="${MAX_BUSINESS_GOVERNANCE_WARNINGS:-0}"
MAX_BILLING_ISSUES="${MAX_BILLING_ISSUES:-1000}"
MAX_UNPRICED_BILLING_RUNS="${MAX_UNPRICED_BILLING_RUNS:-1000}"
...
run_release_smoke() {
  ...
  local args=(
    ...
    --max-unresolved-business-issues "$MAX_UNRESOLVED_BUSINESS_ISSUES"
    --max-business-governance-warnings "$MAX_BUSINESS_GOVERNANCE_WARNINGS"
    --max-billing-issues "$MAX_BILLING_ISSUES"
    --max-unpriced-billing-runs "$MAX_UNPRICED_BILLING_RUNS"
    --report "$report"
  )
